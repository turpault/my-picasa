...
import { buildThumbs } from "./internal/worker-thread";

/**
 * Start the thumbgen worker
 */
async function startWorker(): Promise<void> {
  await buildThumbs();
}

// Initialize worker if running in the thumbgen worker thread
if (workerData?.serviceName === 'thumbgen') {
