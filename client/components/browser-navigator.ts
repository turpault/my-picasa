...
import { AlbumListEvent, AppEventSource, ApplicationState } from "../uiTypes";
...
export async function makeBrowserNavigator(
  ...
  // Create shared event emitter for album list events
  const albumListEvents = buildEmitter<AlbumListEvent>();
